  ...
  <li class="timeline-item-wrap">
    ...
    <div class="timeline-item">
      ...
      @if($history->key == 'created_at' && !$history->old_value)
        <h3 class="timeline-header">{{ $history->userResponsible()?$history->userResponsible()->name:trans('backpack::crud.guest_user') }} {{ trans('backpack::crud.created_this') }} {{ $crud->genero }} {{ $crud->entity_name }}</h3>
      @else
